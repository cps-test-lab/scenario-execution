...
Scenario execution currently supports the ROS 2 distributions `Humble <https://docs.ros.org/en/humble/index.html>`_, `Jazzy <https://docs.ros.org/en/jazzy/index.html>`_ and `Lyrical <https://docs.ros.org/en/lyrical/index.html>`_.

.. note::

   On Lyrical, the ``scenario_execution_nav2`` package is not yet available because navigation2 has not been released for that distribution.

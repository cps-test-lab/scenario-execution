...
class TestGetEntitiesStates(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetEntitiesStates, "/simulation/get_entities_states", self.service_callback)
...
scenario test_get_entities_states:
    timeout(10s)
    do serial:
        get_entities_states()
"""

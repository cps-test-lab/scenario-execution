...
class TestGetEntityBounds(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetEntityBounds, "/simulation/get_entity_bounds", self.service_callback)
...
scenario test_get_entity_bounds:
    timeout(10s)
    do serial:
        get_entity_bounds('/bla')
"""

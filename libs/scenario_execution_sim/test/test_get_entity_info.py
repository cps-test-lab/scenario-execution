...
class TestGetEntityInfo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetEntityInfo, "/simulation/get_entity_info", self.service_callback)

...
class TestGetEntityState(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetEntityState, "/simulation/get_entity_state", self.service_callback)
...
scenario test_get_entity_state:
    timeout(10s)
    do serial:
        get_entity_state('/bla')
"""

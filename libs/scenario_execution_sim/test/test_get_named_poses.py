...
class TestGetNamedPoses(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetNamedPoses, "/simulation/get_named_poses", self.service_callback)

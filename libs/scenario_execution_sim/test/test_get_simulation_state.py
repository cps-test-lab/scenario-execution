...
class TestGetSimulationState(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetSimulationState, "/simulation/get_simulation_state", self.service_callback)
...
scenario test_get_simulation_state:
    timeout(10s)
    do serial:

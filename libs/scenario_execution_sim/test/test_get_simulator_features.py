...
class TestGetSimulatorFeatures(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(GetSimulatorFeatures, "/simulation/get_simulator_features", self.service_callback)
        self.srv_features = []
        self.request_received = None
    ...
    def service_callback(self, msg, response):
        ...
        #response.result.features = self.srv_features
        return response
...
scenario test_get_simulator_features:
    timeout(10s)
    do serial:

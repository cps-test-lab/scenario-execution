...
import py_trees
from simulation_interfaces.srv import SetEntityInfo
from simulation_interfaces.msg import Result

os.environ["PYTHONUNBUFFERED"] = '1'

class TestSetEntityInfo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(SetEntityInfo, "/simulation/set_entity_info", self.service_callback)

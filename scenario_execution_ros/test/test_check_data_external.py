...
class TestRosCheckDataExternal(unittest.TestCase):
    ...
    def test_success(self):
        self.scenario_execution_ros.scenarios_list = self.parser.process_file(
            os.path.join(self.scenario_dir, 'scenarios', 'test', 'test_ros_check_data_external.osc'), False
        )
        self.scenario_execution_ros.scenario_file = os.path.join(self.scenario_dir, 'scenarios', 'test', 'test_ros_check_data_external.osc')
